...
for params in ParameterGrid(param_grid):
    ...
    # Track best
    if early_stopping_f1_train < best_score:
        best_score = early_stopping_f1_train
        best_params = params
        best_model = model


    experiment_name = f'{params['hidden_dim_1']}_{params['hidden_dim_2']}_{params['latent_dim']}_lr{float(params['learning_rate'])*10000}_nw{params['num_weight']}_p3_mindelta0'
...
df_results.to_csv('C:/Users/midon/Documents/anomaly-detection-autoencoder-based-basic/saved_models/hyperparams_tuning/autoencoder/'+'grid_search_results.csv', index=False)